  ...
  const process: ProcessType[] = [
    {
      ...
      description:
        "We begin by diving deep into your vision, your goals, and the problem you’re solving. This stage is all about uncovering the story behind your idea and understanding why it matters.",
      deliverables: [
    ...
    },
    {
      ...
      description:
        "Once we know where you want to go, we carefully map out how to get there. Our team creates structured wireframes and a detailed project scope so that everyone involved knows exactly what’s being built and how.",
      deliverables: [
    ...
    },
    {
      ...
      description:
        "Our designers and developers work hand in hand to turn your vision into a functional, scalable, and visually stunning platform.",
      deliverables: [
    ...
    },
    {
      ...
      description:
        "We provide full support for launch, making sure everything runs smoothly and your product reaches the right audience.",
      deliverables: [
  ...
  return (
    <div ref={sectionRef} className="relative space-y-4 px-4 sm:px-6 lg:px-8">
      <AgencySectionHeading
        ...
        description="A clear, repeatable process that takes you from idea to launch."
        size="md"
        align="center"
        as="h2"
        id="process-heading"
