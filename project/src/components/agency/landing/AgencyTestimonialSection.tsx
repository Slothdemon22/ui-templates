...
function AgencyTestimonialSection() {
  const headingRef = useRef<HTMLDivElement>(null);
  const gridRef = useRef<HTMLDivElement>(null);
  const statsRef = useRef<HTMLElement>(null);

  const testimonials = agencyCaseStudies.filter((cs) => cs.testimonial);
      ...
      >
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col divide-y divide-gray-200 sm:flex-row sm:divide-x sm:divide-y-0">
            <div className="flex flex-1 flex-col items-start px-4 py-4 sm:items-center sm:px-6 sm:py-6 md:py-0" data-stat-item="true">
              <div className="text-heading text-3xl font-semibold sm:text-4xl md:text-5xl">
                120+
              </div>
              <p className="text-label mt-1 text-sm sm:mt-2 sm:text-base">Projects delivered</p>
            </div>
            ...
            <div className="flex flex-1 flex-col items-start px-4 py-4 sm:items-center sm:px-6 sm:py-6 md:py-0" data-stat-item="true">
              ...
              <p className="text-label mt-1 text-sm sm:mt-2 sm:text-base">Global clients</p>
            </div>
            ...
            <div className="flex flex-1 flex-col items-start px-4 py-4 sm:items-center sm:px-6 sm:py-6 md:py-0" data-stat-item="true">
              ...
              <p className="text-label mt-1 text-sm sm:mt-2 sm:text-base">MRR influenced</p>
            </div>
          </div>
        </div>
      </section>
...
export { AgencyTestimonialSection };
