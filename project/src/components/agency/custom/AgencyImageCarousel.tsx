...
import { Carousel, CarouselContent, CarouselItem } from "@/components/agency/ui/carousel";

interface AgencyImageCarouselProps {
  images: string[];
  caseStudyId: number;
  caseStudyName: string;
}

const AgencyImageCarousel: React.FC<AgencyImageCarouselProps> = ({ images, caseStudyName }) => {
  return (
    <div
